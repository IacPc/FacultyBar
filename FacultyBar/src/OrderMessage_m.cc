...
double OrderMessage::getCashierQueueArrivalTime() const
{
    return this->cashierQueueArrivalTime;
}

void OrderMessage::setCashierQueueArrivalTime(double cashierQueueArrivalTime)
{
    this->cashierQueueArrivalTime = cashierQueueArrivalTime;
}

double OrderMessage::getCashierQueueExitTime() const
{
    return this->cashierQueueExitTime;
}

void OrderMessage::setCashierQueueExitTime(double cashierQueueExitTime)
{
    this->cashierQueueExitTime = cashierQueueExitTime;
}

double OrderMessage::getCashierNodeDepartureTime() const
{
    return this->cashierNodeDepartureTime;
}

void OrderMessage::setCashierNodeDepartureTime(double cashierNodeDepartureTime)
{
    this->cashierNodeDepartureTime = cashierNodeDepartureTime;
}

double OrderMessage::getSeatManagerQueueArrivalTime() const
{
    return this->seatManagerQueueArrivalTime;
}

void OrderMessage::setSeatManagerQueueArrivalTime(double seatManagerQueueArrivalTime)
{
    this->seatManagerQueueArrivalTime = seatManagerQueueArrivalTime;
}

double OrderMessage::getSeatManagerQueueExitTime() const
{
    return this->seatManagerQueueExitTime;
}

void OrderMessage::setSeatManagerQueueExitTime(double seatManagerQueueExitTime)
{
    this->seatManagerQueueExitTime = seatManagerQueueExitTime;
}

double OrderMessage::getSeatManagerNodeDepartureTime() const
{
    return this->seatManagerNodeDepartureTime;
}

void OrderMessage::setSeatManagerNodeDepartureTime(double seatManagerNodeDepartureTime)
{
...
std::string OrderMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: return double2string(pp->getCashierQueueArrivalTime());
        case 2: return double2string(pp->getCashierQueueExitTime());
        case 3: return double2string(pp->getCashierNodeDepartureTime());
        case 4: return double2string(pp->getSeatManagerQueueArrivalTime());
        case 5: return double2string(pp->getSeatManagerQueueExitTime());
        case 6: return double2string(pp->getSeatManagerNodeDepartureTime());
        default: return "";
    }
}
...
bool OrderMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 1: pp->setCashierQueueArrivalTime(string2double(value)); return true;
        case 2: pp->setCashierQueueExitTime(string2double(value)); return true;
        case 3: pp->setCashierNodeDepartureTime(string2double(value)); return true;
        case 4: pp->setSeatManagerQueueArrivalTime(string2double(value)); return true;
        case 5: pp->setSeatManagerQueueExitTime(string2double(value)); return true;
        case 6: pp->setSeatManagerNodeDepartureTime(string2double(value)); return true;
